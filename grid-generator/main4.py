...
def create_image_grid_fit(folder_path, output_path, grid_size=(14, 12), cell_size=(40 * 20, 40 * 20), gap=8 * 20, background_color="#1F1F1F"):
    """
...
output_path = './1-1.jpg'  # Replace with the path to save the grid image
